        ...
        <table className="border-collapse bg-white text-sm">
          <thead>
            <tr>
              ...
              <th className="text-xs md:text-sm sticky top-0 left-0 z-30 bg-gray-100 border-b-2 border-r-2 border-gray-300 p-2 min-w-15">
                TEAM
              </th>
              ...
              {NBA_TEAMS.map((team) => (
                <th
                  key={`col-${team}`}
                  className="text-xs md:text-sm sticky top-0 z-20 bg-gray-50 border-b-2 border-r border-gray-300 p-2 font-bold text-blue-900 min-w-[60px]"
                >
                  {team}
                </th>
              ))}
          ...
          <tbody>
            {NBA_TEAMS.map((rowTeam) => (
              <tr key={rowTeam}>
                <td className="text-xs md:text-sm sticky left-0 z-20 bg-gray-50 border-r-2 border-b border-gray-300 p-2 font-bold text-center">
                  {rowTeam}
                </td>
                    ...
                    >
                      ...
                      {cellContent ? (
                        <div className="relative group flex flex-col animate-in fade-in zoom-in duration-300">
                          ...
                          <span className="text-xs md:text-sm font-bold text-blue-900 leading-tight">
